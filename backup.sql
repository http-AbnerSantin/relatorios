...
-- Copiando estrutura do banco de dados para relatorios_regionais
CREATE DATABASE IF NOT EXISTS `relatorios_regionais` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `relatorios_regionais`;

-- Copiando estrutura para tabela relatorios_regionais.regionais
